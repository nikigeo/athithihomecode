...
<h4><i class="fa fa-map-marker"></i>Ernakulam North Railway Station 4 Km</h4>
				...
				<div class="post-box">
					<a href="#">
					<img src="images/Athithi Homes Location Ernakulam.jpg"  alt="ernakulam" width="1000" height="800"> </a>
					
				</div>
                <div class="post-box">
					<a href="#">
					<img src="images/Athithi Homes Location Kadavanthra Kochi.jpg" width="1000" height="800" alt="kadavanthra"> </a>
					
				</div>
                <div class="post-box">
					<a href="#">
					<img src="images/Athithi Homes Kumaranasan Nagar.jpg" width="1000" height="800" alt="knagar" > </a>
